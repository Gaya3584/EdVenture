    ...
    <section className="activities-section">
      ...
      <div className="activities-wrapper">
        ...
        <div className="activity-division lectures">
          <h3>Lectures</h3>
          <p className="actpara">Watch and understand concepts through engaging video lessons.</p>
        ...
        <div className="activity-division fun-activities">
          ...
          <p className="actpara">Learn concepts through games and exciting activities.</p>
          <div className="activity-list">
            <div className="activity-item">
